...
public class Complex {
    ...
    *  @param z an array with z[0] representing the real part
    *  and z[1] representing the imaginary part of the complex number
    */
   ...
   public static void main ( String args[] ) {
      ...
      //ausgabe += ", arg = " + ( z[1] % PI ) + " \u03C0";
      ausgabe += ", arg = " + ( z.z[1] % PI ) + " \u03C0";
